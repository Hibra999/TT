...
def train_and_predict(
    ...
    """
    Elastic Net meta model. Optimiza alpha y l1_ratio con Optuna
    + 5-fold CV sobre OOF.
    ...
    meta_info   : dict con alpha, l1_ratio y oof_mse
    """
    try:
        ...
        best_model = ElasticNet(alpha=best_alpha, l1_ratio=best_l1, max_iter=10000)
        ...
        print(f'  [EN] alpha={best_alpha:.6f}, l1_ratio={best_l1:.4f}, {n_valid}/{n_test} válidas')

        return predictions, {'alpha': best_alpha, 'l1_ratio': best_l1, 'oof_mse': study.best_value}
