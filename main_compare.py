...
pmt_lgb_meta, info_lgb_meta = lgbm_meta_predict(
    oof_df_actual, X_test_bases, n_trials=N_LGB_META, device=device
)

# --- PARTE NEW-1B: Random Forest Meta ---
print('  > Random Forest Meta (Ensamble Actual)...')
pmt_rf_meta, info_rf_meta = rf_meta_predict(
    oof_df_actual, X_test_bases, n_trials=N_RF_META, device=device
)
